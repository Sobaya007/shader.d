...
%fragment.S = type <{ i8, [15 x i8], [5 x <4 x float>], i32 }>
%fragment.BlockName = type { %fragment.S, i8 }
...
$_D8fragment1S6__initZ = comdat any

$_D8fragment9BlockName6__initZ = comdat any
...
@_D8fragment1S6__initZ = constant %fragment.S <{ i8 0, [15 x i8] zeroinitializer, [5 x <4 x float>] [<4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>], i32 0 }>, comdat, align 1 ; [#uses = 0]
@_D8fragment9BlockName6__initZ = constant %fragment.BlockName { %fragment.S <{ i8 0, [15 x i8] zeroinitializer, [5 x <4 x float>] [<4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>], i32 0 }>, i8 0 }, comdat, align 1 ; [#uses = 0]
@blockName = thread_local global %fragment.BlockName { %fragment.S <{ i8 0, [15 x i8] zeroinitializer, [5 x <4 x float>] [<4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>, <4 x float> <float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000, float 0x7FF8000000000000>], i32 0 }>, i8 0 }, comdat, align 1 #3 ; [#uses = 2]
...
define void @fragMain() #4 comdat {
  ...
  %1 = getelementptr inbounds %fragment.BlockName, %fragment.BlockName* @blockName, i32 0, i32 1 ; [#uses = 1, type = i8*]
...
if:                                               ; preds = %0
  ...
  %5 = getelementptr inbounds %fragment.BlockName, %fragment.BlockName* @blockName, i32 0, i32 0 ; [#uses = 1, type = %fragment.S*]
  %6 = getelementptr inbounds %fragment.S, %fragment.S* %5, i32 0, i32 2 ; [#uses = 1, type = [5 x <4 x float>]*]
